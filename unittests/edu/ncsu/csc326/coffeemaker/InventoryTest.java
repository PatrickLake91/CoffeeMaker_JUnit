...
public class InventoryTest extends TestCase {
	...
	@Test
	public void testAddInventory_validInput_shouldPass() throws InventoryException {
	    Inventory inventory = new Inventory();
	    inventory.addInventory("3", "2", "1", "4");
	    String expected = "Coffee: 18\nMilk: 17\nSugar: 16\nChocolate: 19\n";
	    assertEquals(expected, inventory.toString());
	}

	@Test(expected = InventoryException.class)
	public void testAddInventory_negativeInput_shouldThrow() throws InventoryException {
	    Inventory inventory = new Inventory();
	    inventory.addInventory("-1", "2", "1", "3");
	}
